...
ELSE(WIN32)
  ...
  IF (ROOT_FOUND)
    ...
    #HACK to include LeCroyReader
    #SET(LCR_INCLUDE_DIR /home/hjansen/TCT/TCT-analysis/external/LeCroyConverter/include)
    #SET(LCR_LIBRARY_PATH /home/hjansen/TCT/TCT-analysis/external/LeCroyConverter/lib)
    #MESSAGE(STATUS "LCR include dir is: ${LCR_INCLUDE_DIR}")
    #MESSAGE(STATUS "LCR lib path is: ${LCR_LIBRARY_PATH}")
    #SET(ROOT_INCLUDES ${ROOT_INCLUDE_DIR} ${LCR_INCLUDE_DIR})
    #SET(LD_LIBRARY_PATH ${LD_LIBRARY_PATH} ${LCR_LIBRARY_PATH})
    #MESSAGE(STATUS "ROOT includes are: ${ROOT_INCLUDES}")
    #MESSAGE(STATUS "LD lib path is: ${LD_LIBRARY_PATH}")
    #HACK END
